...
Page({
  ...
  submitT: function () {
    if (!this.data.checkBegin) {
      ...
      console.log("吱吱吱吱吱吱吱赞赞赞赞赞");
        wx.redirectTo({
          url: '../oneroomsure/oneroomsure?selectData=' + this.data.selectitem + "&Daydata=" + this.data.selectDday + "&Classtime=" + Classtime + "&sinfonia=" + sinfonia + "&bgcolor=linear-gradient(to top  right,#ac4cff 0%, #9666fe 100%)&bgcoloronly=#9c5ffe&backpage=timeselect&backtab=2"
        })
