    ...
    console.log("zzzzzzzzzzzzzzzz")
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          let urlgo = '../third1select/third1select?Daydata=' + Daydata + "&&roomid=" + that.data.roomid + "&&cnselectTime=" + res.data + "&&selectitem=" + that.data.selectitem;
          wx.redirectTo({
            url: urlgo
          })
        }
